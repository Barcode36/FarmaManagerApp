...
public class ElencoMinsanVenditeLibereController extends ElencoMinsanController implements Initializable {
    ...
    private void elencoProdottiClicked(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/klugesoftware/farmamanager/view/ElencoProdottiVenditeLibere.fxml"));
            Parent parent = (Parent) fxmlLoader.load();
    ...
    private void dettagliClicked(ActionEvent event){
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/klugesoftware/farmamanager/view/ElencoDettagliatoMinsanVenditeLibere.fxml"));
            Parent parent = (Parent) fxmlLoader.load();
