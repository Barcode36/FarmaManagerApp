...
public class FTPConnector {
    ...
    private Logger logger = LogManager.getLogger(com.klugesoftware.FarmaManagerUpdating.ftp.FTPConnector.class.getName());
     ...
     */
    public boolean deleteDirectories(String path){
        boolean ret = false;
        try {
            ret = true;
            initFtpClient();
